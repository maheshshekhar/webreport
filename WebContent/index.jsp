...
String enabled_sql ="SELECT count(*) FROM mfa WHERE date = (SELECT max(date) FROM mfa);";
String inactive_sql ="SELECT count(*) FROM keyrotate WHERE date = (SELECT max(date) FROM mfa);";

enabled_rs= enable_statement.executeQuery(enabled_sql);
inactive_rs= inactive_statement.executeQuery(inactive_sql);
enabled_rs.next();
inactive_rs.next();
int count = enabled_rs.getInt(1);
int count1=inactive_rs.getInt(1);
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        <a href="upload.jsp"><i class="fa fa-fw fa-file"></i> Upload </a>
                    </li> <!--
                    <li>
