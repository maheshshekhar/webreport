...
String enabled_sql ="SELECT * from keyrotate where status='Active' and date=current_date";
String inactive_sql ="SELECT * from keyrotate where status='Inactive' and date=current_date";
